...
def test_three_lines_break_both_columns_no_mini():
    ...
    line3 = "+)\n"
    column1, column2, column3, column_mini = sanedecayrescaling.extract_decays.make_single_line_snippets(line1+line2+line3)
...
def test_two_lines_break_first_columns_two_line_mini():
    ...
    line2 = "                                    vv]\n"
    column1, column2, column3, column_mini = sanedecayrescaling.extract_decays.make_single_line_snippets(line1 + line2)
...
def test_one_line_only_no_mini():
    ...
    column1, column2, column3, column_mini = sanedecayrescaling.extract_decays.make_single_line_snippets(line1)
